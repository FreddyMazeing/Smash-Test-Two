...
const HeroSection = () => {
  return (
    <div className=" relative max-w-full font-montserrat min-h-screen flex items-center bg-gradient-to-b from-[#FF30E3]/80 to-white justify-center">
      ...
      <div className="relative bg-white md:hidden   w-[320px] h-[500px] mx-4 rounded-xl flex items-center justify-center">
        <img
          src={niketnairmax}
          alt="niketnairmax"
          className="rotate-45 absolute inset-0 w-3/4 -left-3 -top-14 z-20"
        />
      </div>
    </div>
  );
